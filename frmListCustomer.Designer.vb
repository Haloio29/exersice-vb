...
Partial Class frmListCustomer
    ...
    Private Sub InitializeComponent()
        ...
        ' Column3
        ' 
        Column3.HeaderText = "Nama Customer"
        ...
        ' txtCari
        ' 
        txtCari.Location = New Point(268, 12)
        ...
        cboCari.Location = New Point(21, 12)
